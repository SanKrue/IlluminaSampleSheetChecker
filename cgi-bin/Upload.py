...
<H2>SampleSheet Checker</H2>
	<p> SampleSheet Checker is a tool for checking a sample sheet, which is used for the assignment of the generated data with an Illumina HiSeq or MiSeq Sequencing System. The application contains several compare functions, which will search for redundancy or e.g. a duplicate Index in different SampleIDs. </p>
